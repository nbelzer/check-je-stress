...
$page->head = "<link rel=\"stylesheet\"
                     href=\"resources/css/specific/index.css\"
                     type=\"text/css\">";
    ...
    <div class="indexImage">
      <div class="row">
        <div class="medium-12 medium-centered columns">
          <div class="backgroundImagefrontpage"
               style="background-image: url('resources/img/background_frontpage.svg');">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row text water" data-equalizer data-equalize-on="medium">
      <div class="medium-10 medium-centered columns">
        ...
        <div class="medium-6 columns" data-equalizer-watch>
          <div class="header" style="color: #CBECF4;">Stel uzelf de onderstaande
                                                      vragen eens:</div>
          <ul class="questions">
            <li>Heeft u het druk op werk?</li>
            <li>Gunt u zichzelf steeds minder tijd voor pauze?</li>
            <li>Neemt u vaak werk mee naar huis?</li>
            <li>Is uw 'accu' gauw leeg en heeft u langer dan normaal last van
                verkoudheden?</li>
          </ul>
        </div>
        ...
        <div class="medium-6 columns" data-equalizer-watch>
          ...
          <ul class="facts">
            <li>38% van de arbeidsongeschiktheid in 2005 komt door psychische
                klachten zoals stress en burn-out</li>
            <li>1 op de 8 werknemers heeft last van een burn-out (bron:
                CBS)</li>
            <li>30.000 mensen worden jaarlijks afgekeurd ten gevolge van
                psychische problematiek</li>
