...
$page->path_to_root = '../';
$page->head = <<<EOF
  <link rel="stylesheet" href="resources/css/specific/standard.css" type="text/css">
  <script>
...
<div class="content">
  ...
  <section class="text water" id="overzicht">
    <div class="row">
      <div class="medium-10 medium-centered columns">
  ...
  <section class="text dark" id="zuidholland">
    <div class="row">
      <div class="medium-10 medium-centered columns">
        <div class="medium-9 columns medium-offset-3">
  ...
  <section class="text water" id="noordholland">
    <div class="row">
      <div class="medium-10 medium-centered columns">
        <div class="medium-9 columns medium-offset-3">
  ...
  <section class="text dark" id="noordbrabant">
    <div class="row">
      <div class="medium-10 medium-centered columns">
        <div class="medium-9 columns medium-offset-3">
  ...
  <section class="text water" id="gelderland">
    <div class="row">
      <div class="medium-10 medium-centered columns">
        <div class="medium-9 columns medium-offset-3">
  ...
  <section class="text dark" id="utrecht">
    <div class="row">
      <div class="medium-10 medium-centered columns">
        <div class="medium-9 columns medium-offset-3">
  ...
  <section class="text water" id="overijssel">
    <div class="row">
      <div class="medium-10 medium-centered columns">
        <div class="medium-9 columns medium-offset-3">
  ...
  <section class="text dark" id="limburg">
    <div class="row">
      <div class="medium-10 medium-centered columns">
        <div class="medium-9 columns medium-offset-3">
  ...
  <section class="text water" id="friesland">
    <div class="row">
      <div class="medium-10 medium-centered columns">
        <div class="medium-9 columns medium-offset-3">
  ...
  <section class="text dark" id="groningen">
    <div class="row">
      <div class="medium-10 medium-centered columns">
        <div class="medium-9 columns medium-offset-3">
  ...
  <section class="text water" id="drenthe">
    <div class="row">
      <div class="medium-10 medium-centered columns">
        <div class="medium-9 columns medium-offset-3">
  ...
  <section class="text dark" id="flevoland">
    <div class="row">
      <div class="medium-10 medium-centered columns">
        <div class="medium-9 columns medium-offset-3">
  ...
  <section class="text water" id="zeeland">
    <div class="row">
      <div class="medium-10 medium-centered columns">
        <div class="medium-9 columns medium-offset-3">
