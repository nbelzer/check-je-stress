...
<div class="content">
    ...
    <div class="medium-10 medium-centered columns">
      <div class="navmenu">
        <ul class="vertical menu" data-magellan data-options="barOffset:40">
          <li><a href="#first">Overzicht</a></li>
          <li><a href="#second">Zuid-Holland</a></li>
          <li><a href="#third">Noord-Holland</a><li>
		  <li><a href="#fourth">Noord-Brabant</a><li>
		  <li><a href="#fifth">Gelderland</a><li>
		  <li><a href="#sixth">Utrecht</a><li>
		  <li><a href="#seventh">Overijssel</a><li>
		  <li><a href="#eighth">Limburg</a><li>
		  <li><a href="#ninth">Friesland</a><li>
		  <li><a href="#tenth">Groningen</a><li>
		  <li><a href="#eleventh">Drenthe</a><li>
		  <li><a href="#twelfth">Flevoland</a><li>
		  <li><a href="#thirteenth">Zeeland</a><li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <section class="text water" id="fifth">
    <div class="row">
      <div class="medium-10 medium-centered columns">
        <div class="medium-9 columns medium-offset-3">
  ...
  <section class="text dark" id="sixth">
    <div class="row">
      <div class="medium-10 medium-centered columns">
        <div class="medium-9 columns medium-offset-3">
  ...
  <section class="text water" id="seventh">
    <div class="row">
      <div class="medium-10 medium-centered columns">
        <div class="medium-9 columns medium-offset-3">
  ...
  <section class="text dark" id="eighth">
    <div class="row">
      <div class="medium-10 medium-centered columns">
        <div class="medium-9 columns medium-offset-3">
  ...
  <section class="text water" id="ninth">
    <div class="row">
      <div class="medium-10 medium-centered columns">
        <div class="medium-9 columns medium-offset-3">
  ...
  <section class="text dark" id="tenth">
    <div class="row">
      <div class="medium-10 medium-centered columns">
        <div class="medium-9 columns medium-offset-3">
  ...
  <section class="text water" id="eleventh">
    <div class="row">
      <div class="medium-10 medium-centered columns">
        <div class="medium-9 columns medium-offset-3">
  ...
  <section class="text dark" id="twelfth">
    <div class="row">
      <div class="medium-10 medium-centered columns">
        <div class="medium-9 columns medium-offset-3">
  ...
  <section class="text water" id="thirteenth">
    <div class="row">
      <div class="medium-10 medium-centered columns">
        <div class="medium-9 columns medium-offset-3">
