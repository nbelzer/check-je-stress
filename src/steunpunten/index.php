...
$page->head = <<<EOF
  <link rel="stylesheet" href="resources/css/specific/information.css"
        type="text/css">
  <link rel="stylesheet" href="resources/css/specific/steunpunten.css"
        type="text/css">
  <script>
  ...
  <div class="content">
    ...
    <div class="row text water" id="first">
      <div class="medium-10 medium-centered columns">
        ...
        <div class="medium-9 columns" id="overzicht">
          ...
          <h5>Overzicht</h5>
          <p>Kies hieronder op de kaart de provincie naar uw keuze.</p>
          <p>
            <object data="resources/img/clickable_map.svg" type="image/svg+xml"
                    width="500"></object>
          </p>
    ...
    <div class="row text water" id="friesland">
      <div class="medium-10 medium-centered columns">
        ...
        <h5>Friesland</h5>
  		  <p>
  			  We hebben (nog) geen steunpunten in Friesland.
          <a href="steunpunten/vacatures/">Klik hier</a> als u zich als
          steunpunt voor deze provincie wilt aanmelden.
  		  </p>
